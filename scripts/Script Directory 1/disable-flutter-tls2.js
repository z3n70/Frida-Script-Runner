...
let MainActivity = Java.use("id.co.bni.newagenbni46.MainActivity");                       
MainActivity["a"].overload().implementation = function () {
    console.log(`MainActivity.a is called`);
    let result = this["a"]();
    console.log(`MainActivity.a result=${result}`);
    return result;

};
          MainActivity["h"].implementation = function () {
    console.log(`MainActivity.h is called`);
    let result2 = this["h"]();
    console.log(`MainActivity.h result=${result}`);
    return result2;
};     
		});